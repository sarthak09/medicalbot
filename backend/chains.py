...
class Chain:
    ...
    def __ragChain__(self, retriever):
        ...
        qa_system_prompt = """Answer the following medical question in 2-3 lines maximum using only the information provided in the context. For answering use simple language that a layman can understand. If you don't know the answer, just say you don't know. Do NOT try to make up an answer.
        Context: {context}"""
